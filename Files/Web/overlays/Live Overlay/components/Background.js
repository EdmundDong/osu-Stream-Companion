const background = {
  ...
  setup(props, context) {
    ...
    const boxStyle = Vue.computed(() => `background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.8)),url(${data.backgroundUrl});`);
    ...
    Vue.watch(
      ...
      () => {
        ...
        let width = 1920,
          height = 1080;
		// Dong: Doesn't work, rescaled improperty so I just disabled it.
