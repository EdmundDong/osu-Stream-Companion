...
const app = {
  ...
  setup(props, context) {
    ...
    let ppValue = Vue.computed(() => {
      if (isPlayingOrWatching.value) return getToken('ppIfMapEndsNow', 0);
      if (data.settings.SimulatePPWhenListening) return getToken('simulatedPp', 0);
      return 0;
    });
  ...
  computed: {
	...
	hitsStyle2() {
      ...
      let { ppBackgroundColor: pp, hit100BackgroundColor: h100, hit50BackgroundColor: h50, hitMissBackgroundColor: hMiss } = this.overlaySettings;
      return `background: linear-gradient(to left, ${pp},${pp},${h100},${h100},${h50},${h50},${hMiss},${hMiss});`;
    },
  },
};
export default app;
